...
def create_cnndm_examples(root, split, debug=False):
...
def create_cnndm_dataset(root, split, tokenizer, max_src_len, max_tgt_len, model_type, raw_cache_dir='', client_id=None,
                         pretrain=False, debug=False, **kwargs):
    if pretrain:
        return create_cnndm_pretrain_dataset(root, split, tokenizer, max_src_len, model_type, raw_cache_dir, client_id, debug)
    ...
    src_examples, tgt_examples = create_cnndm_examples(root, split, debug)
...
def create_cnndm_pretrain_dataset(root, split, tokenizer, max_src_len, model_type, raw_cache_dir='', client_id=None, debug=False):
    if client_id is None:
