...
def create_squad_answer_texts(examples, encoded_inputs, results, n_best_size, max_answer_len, null_score_diff_threshold):
            ...
            for start_index in start_indexes:
                for end_index in end_indexes:
                    ...
                    if end_index not in feature.context_subtok_to_tok_idx:
                        continue
                    if not feature.is_max_context_token.get(start_index, False):
                        continue
...
def compute_squad_metrics(examples, encoded_inputs, results, n_best_size, max_answer_len,
